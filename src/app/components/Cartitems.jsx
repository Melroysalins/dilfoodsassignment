...
const Cartitems = (data) => {
  ...
  return (
    ...
    <div className='flex mt-[13px] w-full p-1 items-center justify-between'>
        ...
        <div className='flex w-[100px] rounded ml-[5px]'>
        ...
        <div className='flex flex-col'>
            ...
            <p className='font-medium opacity-50 text-[14px]'>{Subname}</p>
            <p>Rs - {totalprice}</p>
        ...
        <div className='flex items-center justify-between'>
            ...
            <button className='font-semibold text-[20px] cursor-pointer bg-slate-600 text-white w-[40px] rounded-md' onClick={()=>disptach(IncrementQuantity(Id))}>+</button>
            <span className='font-medium ml-2'>{quantity}</span>
            <button className=' ml-2 font-semibold text-[20px] cursor-pointer bg-slate-600 text-white w-[40px] rounded-md' onClick={()=>disptach(DecrementQuantity(Id))}>-</button>
